            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <img width="32" className="rounded-full icon-glow" src="/img/logo.gif" />
                        <p className=" font-extrabold ml-1 text-2xl">Relax Bot</p>
                    </div>
            ...
            <header>
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Relax</span>Bot</a>
                            </p>
                        </div>
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Link href="https://discord.com/oauth2/authorize?client_id=1235176997794353204&permissions=8&scope=bot+applications.commands">
