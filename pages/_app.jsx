...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/invite/ECYDEwXhMB",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1235176997794353204&permissions=8&scope=bot+applications.commands",
    },
       {
      link: true,
      name: "Vote",
